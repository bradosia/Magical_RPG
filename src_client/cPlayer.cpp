...
bool cPlayer::CollidesUD(bool *collision_map, std::list<cBicho*> &enemies,
		bool up) {
...
bool cPlayer::CollidesLR(bool *collision_map, std::list<cBicho*> &enemies,
...
void cPlayer::RestrictedMoveUp(bool *collision_map, std::list<cBicho*> &enemies,
...
void cPlayer::RestrictedMoveDown(bool *collision_map,
...
void cPlayer::MoveLeft(bool *collision_map, std::list<cBicho*> &enemies,
		bool vertical) {
	std::cout << "GetX()=" << GetX() << " GetY()=" << GetY() << std::endl;
	int xaux;
...
void cPlayer::MoveRight(bool *collision_map, std::list<cBicho*> &enemies,
		bool vertical) {
	std::cout << "GetX()=" << GetX() << " GetY()=" << GetY() << std::endl;
	int xaux;
...
void cPlayer::setTest(int test_) {
	test = test_;
}
